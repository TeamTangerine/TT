  ...
  return (
    <div className="h-screen bg-[#EA7F42]">
      ...
      <div className="fixed bottom-[-3rem] w-screen h-[362px] rounded-[20px] bg-[#fff] flex flex-col items-center pt-[50px] gap-[10px]">
        <EmailLogin logoImg={kakaoLogo} name="카카오톡" borderColor={borderColors.kakao} altText="카카오톡 로고" />
        <EmailLogin logoImg={googleLogo} name="구글" borderColor={borderColors.google} altText="구글 로고" />
        <EmailLogin
          logoImg={facebookLogo}
          name="페이스북"
          borderColor={borderColors.facebook}
          altText="페이스북 로고"
        />
        <div>
