 ...
 * - Small: 'text-[12px]'
 */
export enum BtnTextSize {
  Large = 'text-[14px]',
  Small = 'text-[12px]',
}

/**
 * @param BtnWidth 버튼 가로 길이
...
/**
 * @param BtnRadius 버튼 border-radius
